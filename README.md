...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/JaninduPremathilaka/DevSecOps-Netflix-Pipeline-Project.git
    ```
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/JaninduPremathilaka/DevSecOps-Netflix-Pipeline-Project.git'
            }
        }
